...
- Code truth checked on 2026-07-03: `VERSION` and `package.json` are `0.25.0.0`; `bun test` has 1334 tests.
...
- GitHub releases are published through `v0.24.0.0` (verified 2026-07-03); `v0.25.0.0`'s body is prepared in `docs/RELEASE-NOTES.md` for publication next.
