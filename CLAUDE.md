...
- Code truth checked on 2026-07-03: `VERSION` and `package.json` are `0.29.0.1`; `bun test` has 1440 tests.
...
- GitHub releases are published through `v0.29.0.1` (verified 2026-07-03).
