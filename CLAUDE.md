...
- Published GitHub releases stop at `v0.28.0.0` (verified 2026-07-03 via `gh release list`); `v0.29.0.0` through `v0.34.0.0` are CHANGELOG-only so far, with draft GitHub release bodies prepared in `docs/RELEASE-NOTES.md`.
