...
- Code truth checked on 2026-07-03: `VERSION` and `package.json` are `0.27.0.0`; `bun test` has 1368 tests.
...
- GitHub releases are published through `v0.26.0.0` (verified 2026-07-03); `v0.27.0.0`'s body is prepared in `docs/RELEASE-NOTES.md` for publication after merge.
