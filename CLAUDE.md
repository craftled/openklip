...
Re-checked 2026-07-15 after v0.42.0.3 (live sync + deferred MCP surface; PRs #107, #108).

- **Version:** `0.42.0.3` in `VERSION` and `package.json` (GitHub publish pending; features merged in #107 and #108).
...
- **Published GitHub releases:** through `v0.42.0.1` (published 2026-07-13); `v0.42.0.2` and `v0.42.0.3` drafts in release notes.
