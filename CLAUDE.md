...
- Code truth checked on 2026-07-02: `VERSION` and `package.json` are `0.14.1.0`; `bun test` has 1131 tests.
...
- Published GitHub releases were checked on 2026-07-02 and stopped at `v0.10.0.1`; `v0.11.0.0` through `v0.14.0.0` are being published today (2026-07-02) from their prepared bodies; a draft for `v0.14.1.0` also exists.
