...
- Published GitHub releases through `v0.41.1.0` (`gh release view v0.41.1.0`). `v0.41.1.0` merged to `main` at `cea7939` (PR #78). Release bodies live in `docs/RELEASE-NOTES.md` (extract the matching version section at ship).
