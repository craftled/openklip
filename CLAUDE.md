...
Re-checked 2026-07-13 after v0.42.0.2 docs release (PR #104 follow-up: Grok Voice integration documentation).

- **Version:** `0.42.0.2` in `VERSION` and `package.json` (GitHub publish pending; feature merged in #104).
...
- **Published GitHub releases:** through `v0.42.0.1` (published 2026-07-13); `v0.42.0.2` draft in release notes.
