...
- Code truth checked on 2026-07-04: `VERSION` and `package.json` are `0.40.0.0`; `bun test` has 1738 tests (0 fail); `openklip tools --json --surface mcp` lists 76 MCP tools; `openklip actions --json` lists 42 registry actions.
