...
- Published GitHub releases: `v0.41.0.4` on `main` through tag `9383595`; `v0.41.1.0` merged to `main` at `cea7939` (PR #78). Release bodies live in `docs/RELEASE-NOTES.md` (extract the matching version section at ship).
