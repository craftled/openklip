...
- Published GitHub releases stop at `v0.28.0.0` (verified 2026-07-04 via `gh release list`; publishing `v0.29.0.0` through `v0.39.0.0` is in progress); `v0.29.0.0` through `v0.39.0.0` are CHANGELOG-only so far, with draft GitHub release bodies prepared in `docs/RELEASE-NOTES.md` through `v0.39.0.0`.
