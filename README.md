...
Verified against the current codebase (`VERSION` / `package.json` `0.41.1.2`, 1904 tests: 1901 pass, 3 skip without `OPENKLIP_INTEGRATION=1`):
...
- **Editor layout**: fixed 20rem shadcn sidebars; left rail switches between Chats, Assets, and Config; right rail is a collapsible chat timeline; center column has extracted preview header/format/export chrome, transcript, and a bottom timeline drawer
