...
Verified against the current codebase (619 tests, v0.10.0.0):
...
- **MCP server**: `openklip mcp` (stdio) exposes 55 tools with CLI/GUI parity; `.cursor/mcp.json` wired for Cursor
