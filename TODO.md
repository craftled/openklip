...
- [x] **TDD test suite** (`bun test`: 1017 tests across actions, captions, EDL, exporter, project lock, chats, assets, workspace, agent-tools, templates, graphics, headless render, reanchor, multi-take assembly, product announcement, audio analysis, cleanup, cut snap, and more)
