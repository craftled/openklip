...
- Export platform presets (`youtube`, `youtube-4k`, `x`, `linkedin`, 2026-07-03) are landscape (16:9) only; there is no vertical (9:16) or square (1:1) preset, so TikTok/Reels/Shorts destinations are intentionally absent until the vertical reframe milestone lands.
