...
export const PromptInputProvider = ({
  ...
  const openRef = useRef<() => void>(() => {
    // Registered when PromptInput mounts.
  });
...
> & {
  ...
  /** Extra classes merged onto the inner InputGroup (layout, overflow). */
...
export const PromptInputTabItem = ({
  ...
  <div
    className={cn(
      "flex items-center gap-2 px-3 py-2 text-xs fine-hover:hover:bg-foreground/5",
      className
    )}
    {...props}
  />
