  ...
  return (
    ...
    >
      ...
      >
        ...
        <span
          aria-hidden="true"
          className="pointer-events-none absolute top-1/2 left-3 inline-flex -translate-y-1/2 items-center font-medium text-(--elastic-slider-label) text-[11px]/none transition-colors"
        ...
        <span
          aria-hidden="true"
          className={cn(
            "pointer-events-none absolute top-1/2 right-3 -translate-y-1/2 font-medium font-mono text-(--elastic-slider-label) text-[11px]/none transition-colors",
