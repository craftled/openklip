...
function HighlightRow({
  ...
  return (
    <li>
      <button
        className={cn(
          "flex w-full items-start gap-1.5 rounded-md border px-2 py-1 text-left transition-colors hover:bg-muted/50 disabled:pointer-events-none disabled:opacity-50",
...
export function HighlightsPanel({
  ...
  return (
    <div className="flex flex-col gap-1.5" data-highlights-panel>
