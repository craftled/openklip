      ...
      <SliderPrimitive.Control className="relative flex w-full cursor-pointer touch-none select-none items-center data-vertical:h-full data-vertical:min-h-40 data-vertical:w-auto data-disabled:cursor-not-allowed data-vertical:flex-col data-disabled:opacity-50">
        ...
        {Array.from({ length: _values.length }, (_, index) => (
          <SliderPrimitive.Thumb
            className="relative block size-3 shrink-0 cursor-pointer select-none rounded-full border border-ring bg-white ring-ring/50 transition-[color,box-shadow] after:absolute after:-inset-3.5 hover:ring-3 focus-visible:outline-hidden focus-visible:ring-3 active:ring-3 disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50"
